...
class QualityEstimator {
 public:
  /// Computes quality-scores using values from ProcessedRequestSentences and subword tokens which comes from Response
  ///
  ///
  /// @param [in] processedRequestSentences: ProcessedRequestSentences obtained from translating a blob of source-text
  ...
  virtual void computeQualityScores(const ProcessedRequestSentences &processedRequestSentences,
...
class UnsupervisedQualityEstimator : public QualityEstimator {
 public:
  void computeQualityScores(const ProcessedRequestSentences &processedRequestSentences,
                            Response &response) const override;

 private:
  Response::SentenceQualityScore computeSentenceScores(const ProcessedRequestSentence::WordScores &logProbs,
...
class LogisticRegressorQualityEstimator : public QualityEstimator {
 ...
 private:
  ...
  Matrix extractFeatures(const std::vector<SubwordRange> &wordIndices,
                         const ProcessedRequestSentence::WordScores &logProbs) const;
};
