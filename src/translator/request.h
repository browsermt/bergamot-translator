...
class Request {
 public:
  ...
  /// @param [in] model: Translation model the Request is to be translated with. Required to cache correctly between
  /// multiple models.
 ...
 private:
  ...
  std::vector<ProcessedRequestSentence> processedRequestSentences_;
